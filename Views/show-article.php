<div class="container">
    <div class="container">
        <div class="mt-5" style="background-image:url(<?=htmlspecialchars_decode($article->image)?>)"></div>
        ...
        <?php if ($currentUser['admin'] == true) : ?>
           <div class="action">
                ...
                <a class="btn btn-primary" href="index.php?page=form-article&id=<?=htmlspecialchars_decode($article->id)?>">Editer l'article</a>
            </div> 
            <?php endif;?>
    </div>
    <div class="container ">
