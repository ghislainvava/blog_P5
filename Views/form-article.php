<div class="container ">
    <div class="content">
        <div class="block p-20 form-container mt-5">
            ...
            <form action = "index.php?page=form-article<?=htmlentities($_id)? "&id=htmlentities($_id)" : '' ?>"  method="POST" enctype='multipart/form-data'>
                ...
                <div class="container form-actions">
                    ...
                    <button class="btn btn-primary" type="submit"><?= htmlentities($_id) ? 'Modifier' : 'Sauvegarder' ?></button>
                </div>
            </form>
        </div>
    </div>
